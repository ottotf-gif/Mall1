...
export const kund: KundConfig = {
  ...
  /* ─── Tema ────────────────────────────────────────────────────────
   *  accent = kundens profilfärg (knappar, ikoner, detaljer)
   *  jour   = larmfärgen. Låt den vara röd även om accenten är blå.
   *           Jour-sektionen ska skrika "akut", inte "varumärke".
   * ─────────────────────────────────────────────────────────────── */
  tema: {
    accent: '#E8722C',
    jour: '#D92D20',
