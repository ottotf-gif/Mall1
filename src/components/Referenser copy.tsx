...
/**
 * Tre skäl, satta som en stämplad tabell mot kalkbakgrund.
 * Egen bakgrund istället för Sektion-skalet, så att den läser som
 * ett eget band mellan tjänster och referenser.
 */
