...
/**
 * Solid bar, alltid. Inga transparensövergångar vid scroll —
 * en skylt byter inte utseende när man går förbi den.
 */
      ...
      <div className="mx-auto max-w-sida px-5 sm:px-8">
        <div className="flex h-16 items-center justify-between sm:h-[4.5rem]">
          ...
          <div className="flex items-center gap-1">
            {/* På mobil sitter ringknappen fast i botten istället — där är tummen */}
            <a
