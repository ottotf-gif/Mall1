...
export default function Header() {
  ...
  // Headern blir ogenomskinlig först när man scrollat — över hero-
  // bilden ska den vara transparent så bilden får andas.
  useEffect(() => {
      ...
      <div className="mx-auto max-w-sida px-5 sm:px-8">
        <div className="flex h-16 items-center justify-between sm:h-20">
          ...
          <div className="flex items-center gap-2">
            {/* Ringknapp — dold på mobil, där har vi den fasta i botten istället */}
            <a
