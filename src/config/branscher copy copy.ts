...
/**
 * Referensbilderna får stå orörda, med bildtexten UNDER bilden.
 *
 * Det vanliga greppet — en mörk toning över bilden med texten i —
 * gör två saker fel: det suddar bilden av jobbet, och det ser ut som
 * varenda annan sajt. Här ska man se hantverket. Bilden är beviset.
 */
