...
/**
 * Offertformulär, satt som en blankett.
 *
 * OBS: mallen skickar ingenting. handleSkicka visar bara kvittensvyn.
 * Koppla in Formspree/Web3Forms där när du sätter upp en riktig kund.
 *
 * Få fält, medvetet. Namn och telefon räcker för att ta kontakt —
 * hantverkaren ringer ändå upp. Varje extra obligatoriskt fält kostar
 * ifyllda formulär.
 */
...
/* ── Byggstenar, bara för det här formuläret ─────────────────────── */
