 ...
 *   KUNDKONFIGURATION
 *
 *   Det här är den enda filen du behöver ändra för en ny kund.
 *   Allt innehåll, alla färger, all kontaktinfo bor här.
 *
 *   Snabbstart:
 *     1. Sök efter FIRMANAMN och byt ut.
 *     2. Sök efter [ORT] och byt ut.
 *     3. Byt telefon, e-post, orgnr.
 *     4. Sätt tema.accent till kundens profilfärg.
 *     5. Byt bilder (referenser + hero).
 *
 *   Färdiga branschmallar finns i branscher.ts — kopiera in
 *   tjänsterna därifrån istället för att skriva nya.
 *
 * ══════════════════════════════════════════════════════════════════ */
...
export const kund: KundConfig = {
  ...
  /* ─── Tema ────────────────────────────────────────────────────────
   *
   *  accent = kundens profilfärg. Standard är arbetsblå — svenska
   *           hantverkare bär blått, och det är en färg som inte
   *           konkurrerar med jourfärgen.
   *
   *  jour   = larmfärgen. LÅT DEN VARA RÖD. Även om kunden har en röd
   *           logotyp. Om accent och jour ligger nära varandra slutar
   *           jour-sektionen att sticka ut, och då tappar sidan sin
   *           viktigaste funktion.
   *
   *  Tumregel: accent ska vara mörk och lugn. Jour ska vara skrikig.
   * ─────────────────────────────────────────────────────────────── */
  tema: {
    accent: '#1B3A6B',
    jour: '#D01C0F',
  ...
  hero: {
    ...
    // *Stjärnor* runt ordet som ska få accentfärg.
